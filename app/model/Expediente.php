...
class Expediente extends Model {
    ...
    public function create(): bool {
        $sql = "INSERT INTO expediente (hora_inicio, hora_fim) 
                VALUES (:hora_inicio, :hora_fim)";
        ...
        if ($result) {
            $this->setCodExpediente(database\Connection::getInstance()->lastInsertId());
        }
